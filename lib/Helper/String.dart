...
final Uri getEbookApi = Uri.parse('${baseUrl}get_ebook_list');
final Uri getPlansApi = Uri.parse('${baseUrl}get_subscription_list');
final Uri subscribedPlan = Uri.parse('${baseUrl}subscribed_plan');
final Uri getSliderApi = Uri.parse('${baseUrl}get_slider_images');
final Uri getCatApi = Uri.parse('${baseUrl}get_categories');
final Uri getTemplesApi = Uri.parse('${baseUrl}get_temple_list');
final Uri getLiveVideo = Uri.parse('${baseUrl}get_livevideo_link');
final Uri getSuvicharApi = Uri.parse('${baseUrl}get_suvichar_list');
...
const String imgUrl =  'https://nishkamkarmyogimasik.com';
String? CUR_CURRENCY = '';
