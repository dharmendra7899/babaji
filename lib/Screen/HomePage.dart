...
import 'package:eshop/Provider/SettingProvider.dart';
import 'package:eshop/Screen/Emasik_Page.dart';
import 'package:eshop/Screen/Suvichar_page.dart';
import 'package:eshop/Screen/Temples_page.dart';
import 'package:eshop/Screen/VideoList.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          Text(
            '${pincode != null ? getTranslated(context, 'SELOC')! : getTranslated(context, 'DELIVERTO')!}  ${pincode ?? ''}',
